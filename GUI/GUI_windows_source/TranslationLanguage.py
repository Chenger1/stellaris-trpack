...
# Form implementation generated from reading ui file 'GUI_windows_source\TranslationLanguage.ui'
#
...
"    }")
        ...
        self.GridLangButtonsLayout.setSizeConstraint(QtWidgets.QLayout.SetFixedSize)
