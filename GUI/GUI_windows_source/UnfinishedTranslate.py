...
# Form implementation generated from reading ui file 'UnfinishedTranslate.ui'
#
...
"    }")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.InfoLabel.setText(_translate("Dialog", "Вы уверены что хотите закончить перевод?"))
        ...
        self.DeniedButton.setText(_translate("Dialog", "Нет, я продолжу"))
        self.AcceptButton.setText(_translate("Dialog", "Да, я хочу закончить"))
