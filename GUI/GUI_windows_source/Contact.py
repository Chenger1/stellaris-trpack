...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.GitHubChengerLink.setText(_translate("Dialog",
                                                  "<html><head/><body><p><a "
                                                  "href=\"https://github.com/Chenger1\"><span style=\" "
                                                  "text-decoration: underline; "
                                                  "color:#ffffff;\">GitHub</span></a></p></body></html>"))
        self.TelegramChengerLink.setText(_translate("Dialog", "Telegram"))
        self.LetisoLabel.setText(_translate("Dialog", "Letiso"))
        self.TelegramLetisoLink.setText(_translate("Dialog",
                                                   "<html><head/><body><p><a "
                                                   "href=\"https://t.me/Letiso_Dianta\"><span style=\" "
                                                   "text-decoration: underline; "
                                                   "color:#ffffff;\">Telegram</span></a></p></body></html>"))
        self.SteamLetisoLink.setText(_translate("Dialog",
                                                "<html><head/><body><p><a href=\"http://steamcommunity.com/id/letiso"
                                                "\"><span style=\" text-decoration: underline; "
                                                "color:#ffffff;\">Steam</span></a></p></body></html>"))
        self.GitHubLetisoLink.setText(_translate("Dialog",
                                                 "<html><head/><body><p><a href=\"https://github.com/Letiso\"><span "
                                                 "style=\" color:#ffffff;\">GitHub</span></a></p></body></html>"))
