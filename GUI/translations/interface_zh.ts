...
Перезапустите утилиту, чтобы увидеть изменения.Неверный ключ [Для разработчиков]</source>
        <translation>翻译文件编写成功.文件已保存.修改成功排序.界面语言已更改

重新启动实用程序以查看更改.无效的密钥[对于开发人员]</translation>
    </message>
    <message>
...
Пункты про выбор модов:</source>
        <translation>在翻译过程中，“本地化” 按钮是您最好的朋友，但是只有在选择了修改后，该按钮才起作用

修改的翻译可以在任何阶段保

以便以后从集合中继续进行:</translation>
    </message>
    <message>
        <location filename="../../GUI_windows_source/Reference.py" line="614"/>
        <source>1.1. Вручную</source>
        <translation>1.1. 手动地</translation>
    </message>
    <message>
...
В частности, игра принимает только первый одноименный файл с локализацией, а потому при неправильном расположении модов в списке загрузки переводы могут не работать</source>
        <translation>该功能甚至在游戏启动器中出现排序之前就已经开始开发，但是尽管如此，它还是有其优势

通常，尤其是在进行大量修改的情况下，有必要更改修改顺序，而不是按字母顺序排列，以避免冲突

特别是，游戏仅接受具有本地化名称的第一个文件，因此，如果修改错误地位于下载列表中，则翻译可能无效</translation>
    </message>
    <message>
...
Если отметить мод как &quot;Не сортировать&quot; то он сохранит свой порядок относительно аналогично выделенных модов и все они будут помещены ПОД остальными модификациями, что будут сортироваться по алфавиту</source>
        <translation>重要的是，将具有本地化的修改置于下载列表的最底部，而您又不想每次都手动移动修改，因此排序器具有“不排序”功能，该功能看起来像是拒绝了蓝色箭头

如果将修改标记为“不排序”，则它将相对于类似选择的修改保持其顺序，并且所有修改都将置于其他修改之下，并按字母顺序</translation>
    </message>
    <message>
        <location filename="../../GUI_windows_source/Reference.py" line="643"/>
        <source>3. Коллекция</source>
        <translation>3. 收集</translation>
    </message>
    <message>
        <location filename="../../GUI_windows_source/Reference.py" line="644"/>
        <source>3.1. Функционал внутри утилиты</source>
        <translation>3.1. 实用程序内部的功能</translation>
    </message>
    <message>
...
Также можно переключать режимы отображения информации кликом по &quot;SteamWorkshop ID&quot;</source>
        <translation>该窗口不需要重复手动选择已经添加到修改集合中的文件，并且包含以下基本数据：

修订名称，标识符，所有本地化文件的名称以及与要保存的修订关联的名称列表，以及本地化完成的百分比

如果翻译尚未完成，则可以从上一个活动行继续进行该过程或开始新的翻译

为此，只需单击id即可打开带有修改的文件夹，本地化文件的名称或名称列表以继续或开始新的翻译

您也可以通过单击 “SteamWorkshop ID” 来切换信息显示模式</translation>
    </message>
    <message>
        <location filename="../../GUI_windows_source/Reference.py" line="654"/>
        <source>3.2. Локальный мод-сборник из локализаций</source>
        <translation>本地化的本地修改集</translation>
    </message>
    <message>
...
Стандартным именем является &quot;Stellaris True Machine Translation Tool&quot;, но вы всегда можете его изменить, выбрав пункт &quot;Переименовать&quot;</source>
        <translation>
通常，集合是由实用程序生成并位于stellaris文档中的独立修改，它由上述本地化组成，也就是说，它包含该实用程序的所有翻译

该系列可以使用 Stellaris 启动器作为普通模块发布到 Steam 创意工坊

默认名称为 &quot;Stellaris True Machine Translation Tool&quot;，但您始终可以通过选择“重命名”进行更改</translation>
    </message>
    <message>
        <location filename="../../GUI_windows_source/Reference.py" line="661"/>
        <source>4. Язык интерфейса</source>
        <translation>4. 界面语言</translation>
    </message>
    <message>
...
Просьба обращаться к разработчикам, если заметите неточности в переводе, т.к. перевод, в большинстве своем, машинный
        ...
        <translation>很简单-单击所需语言的按钮，魔术就起作用了

有5种语言可供选择：
英文，俄文，乌克兰文，波兰文和中文

如果您发现翻译中有任何不正确之处，请与开发人员联系。翻译大部分是机器
</translation>
    </message>
    <message>
        <location filename="../../GUI_windows_source/Reference.py" line="669"/>
        <source>5. Язык перевода</source>
        <translation>5. 翻译语言</translation>
    </message>
    <message>
...
Нужно два раза кликнуть и удалить текст поиска, затем __ на языке интерфейса __ ввести искомый язык</source>
        <translation>一切都与第3点类似，只有使用搜索的机会

您需要双击并删除搜索文本，然后以界面语言输入所需的语言</translation>
    </message>
    <message>
        <location filename="../../GUI_windows_source/Reference.py" line="673"/>
        <source>6. Об утилите</source>
        <translation>6. 关于实用程序</translation>
    </message>
    <message>
...
Все ссылки кликабельны, а почту можно выделить двойным кликом, чтобы скопировать</source>
        <translation>该窗口包含指向从其开始工作的源代码的链接，以及与我们联系的联系信息

所有链接都是可单击的，并且可以双击选择邮件进行复制</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;简化本地化流程&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
