...
class AcceptWindow(QtWidgets.QDialog, Accept.Ui_Dialog):
    def __init__(self, parent, message):
        ...
        self.messages = {'collection_continue_translation': f'Хотите продолжить перевод мода - {parent.message}',
        ...
        self.init_handlers(message)
        self.messege = ''

    def init_handlers(self, message):
        self.ExitButton.clicked.connect(self.close)
        self.AcceptButton.clicked.connect(self.functions[message])
